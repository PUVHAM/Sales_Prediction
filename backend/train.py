...
from backend.models import create_polynomial_features
from backend.config import DatasetConfig, ModelConfig
from backend.load_dataset import load_df, split_dataset
...
def train_and_cache_models(model_type):
    ...
    model.save(f"backend/models/{model_type}_model.pkl")
